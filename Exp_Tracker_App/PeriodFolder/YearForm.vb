...
Public Class YearForm
    ...
    Private Sub YearForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        curveCorners()
        roundControlCorners(selectYearLabelPanel, 15)
        roundControlCorners(yearPicker, 15)
